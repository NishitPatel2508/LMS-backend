...
//Create
router.post('/contentvideo/create',authenticateToken, async(req,res) => {
...
//Get All Data
router.get('/getAllContentVideo' ,authenticateToken, async(req,res) =>{
    const userid = req.user.id;
    console.log(userid);
    try{
        const instructorExist = await Instructor.findById({_id:userid})
...
// Get Single Data
router.get('/contentvideo/:id' ,authenticateToken,async(req,res) =>{
...
//Update
router.patch('/contentvideo/update/:id',authenticateToken, async(req,res) =>{
    const id = req.params.id
    const userid = req.user.id;
    console.log(userid);
    try{
...
//Delete
router.delete('/contentvideo/delete/:id',authenticateToken, async(req,res) =>{
    const id = req.params.id
    const userid = req.user.id;
    console.log(userid);
    try{
