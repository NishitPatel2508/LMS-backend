...
router.post('/content/create',authenticateToken, async(req,res) => {
        try{
            const {  
                course,
                chapter,
...
router.get('/getAllContent',authenticateToken, async(req,res) => {
    const userid = req.user.id;
    console.log(userid);
    try{
        const instructorExist = await Instructor.findById({_id:userid})
...
//Update Content
router.patch('/content/update/:id',authenticateToken, async(req,res) =>{
    const id = req.params.id;
    const userid = req.user.id;
    console.log(userid);
    try{
...
//Delete Content
router.delete('/content/delete/:id',authenticateToken, async(req,res) =>{
    const id = req.params.id;
    const userid = req.user.id;
    console.log(userid);
    try{
