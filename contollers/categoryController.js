  ...
  try {
    ...
    if (instructorExist) {
      ...
      return res
        ...
        .json({ message: ErrorMessages.CREATED, data: createCategory });
    } else {
      return res
        .status(HTTPStatusCode.BAD_REQUEST)
  ...
  try {
    ...
    if (instructorExist) {
      ...
      return res
        ...
        .json({ message: ErrorMessages.GETDATA, data: getAllCategory });
    }
  } catch {
    return res
      .status(HTTPStatusCode.INTERNAL_SERVER)
    ...
    if (instructorExist) {
      if (ObjectId.isValid(id)) {
        ...
        if (singleCategory) {
          return res
            .status(HTTPStatusCode.OK)
            .json({ message: ErrorMessages.GETDATA, data: singleCategory });
        } else {
          return res
            .status(HTTPStatusCode.BAD_REQUEST)
    ...
    if (instructorExist) {
      if (ObjectId.isValid(id)) {
        ...
        if (updateCategory) {
          return res
            .status(HTTPStatusCode.OK)
            .json({ message: ErrorMessages.UPDATED, data: updateCategory });
        } else {
          return res
            .status(HTTPStatusCode.BAD_REQUEST)
            .json({ message: ErrorMessages.NOT_EXISTS });
    ...
    if (instructorExist) {
      if (ObjectId.isValid(id)) {
        ...
        if (deleteCategory) {
          return res
            .status(HTTPStatusCode.OK)
            .json({ message: ErrorMessages.DELETED, data: deleteCategory });
        } else {
          return res
            .status(HTTPStatusCode.BAD_REQUEST)
            .json({ message: ErrorMessages.NOT_EXISTS });
